...
const int adrGXOutH = 0x3B;   //Adresse GYRO_X_OUT_HIGH (folgende 5 Register bis GYRO_Z_OUT_LOW)
...
void loop() {
  ...
  calculateSpeeds();      // => \Unterprogramme.ino\calculateSpeeds(E)
}
...
void readGyro() {
  ...
  readGyro_checkY();      // => \Unter-Unterprogramme.ino\readyGyro_checkY
